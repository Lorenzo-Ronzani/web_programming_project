...
const CourseEdit = () => {
  ...
  useEffect(() => {
    ...
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
        const foundCourse = data.find((c) => c.code === code);
      ...
      .catch((err) =>
        console.error("Error loading course for edit from API:", err)
      )
    ...
    <div className="flex min-h-screen flex-col bg-gray-50">
      ...
      <main className="container mx-auto flex-1 px-6 py-8">
        <div className="mx-auto max-w-3xl rounded-2xl bg-white p-6 shadow-md">
          ...
          {loading && isEditMode ? (
            <p className="text-gray-500 mb-4">Loading course data...</p>
          ) : (
            <form onSubmit={handleSave} className="space-y-5">
              ...
              {/* Instructor + Photo (Photo oculto por enquanto) */}
