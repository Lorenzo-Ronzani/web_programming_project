    ...
    <div className="mx-auto w-[95%] max-w-[1600px] px-6">
      <div className="mt-1 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600">
          Choose the program that fits your career goals and timeline. All programs are designed to give you
        ...
        <div className="mt-18 grid grid-cols-[repeat(auto-fit,minmax(340px,1fr))] gap-6">
          {displayedPrograms.map((program) => (
            <div
              key={program.id}
              className="flex flex-col min-h-[480px] cursor-pointer rounded-xl bg-white p-6 shadow-lg duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
              {/* Icon */}
